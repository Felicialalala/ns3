...
NrPhy::DoUpdateRbNum()
{
    ...
    NS_LOG_INFO("Channel bandwidth:"<<GetChannelBandwidth());
    NS_LOG_INFO("rbOh:"<<m_rbOh);
    NS_LOG_INFO("subcarrierSpacing:"<<m_subcarrierSpacing);
    NS_LOG_INFO("SUBCARRIERS_PER_RB:"<<NrSpectrumValueHelper::SUBCARRIERS_PER_RB);
    NS_LOG_INFO("realBw:"<<realBw<<"; rbWidth:"<<rbWidth);
