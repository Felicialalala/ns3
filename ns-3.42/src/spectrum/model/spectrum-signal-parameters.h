...
struct SpectrumSignalParameters : public SimpleRefCount<SpectrumSignalParameters>
{
     ...
     * 波形的功率谱密度（PSD），采用线性单位，具体单位取决于传输介质类型
     */
